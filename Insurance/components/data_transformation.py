...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        try:
            ...
            roboust_scaler = RobustScaler()
            pipeline = Pipeline(steps= [
                ('Imputer', simple_imputer),
                ('RoboustScaler', roboust_scaler)
            ])
    ...
    def initiate_data_transformation(self,) -> artifact_entity.DataTransformationArtifact:
        try:
            ...
            utils.save_numpy_data(file_path=self.data_transformation_config.transform_train_path,array=train_arr)

            utils.save_numpy_data(file_path=self.data_transformation_config.transform_test_path,array=test_arr)
