...
class Datavalidation:
    ...
    def is_requried_columns_exists(self, base_df:pd.DataFrame, current_df:pd.DataFrame, report_key_name:str)-> bool:
        try:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            train_df_columns_status = self.is_requried_columns_exists(base_df= base_df, current_df= train_df, report_key_name="Missing_columns_train_dataset")
            test_df_columns_status = self.is_requried_columns_exists(base_df= base_df, current_df= test_df, report_key_name="Missing_columns_test_dataset")
